			...
			if IsControlJustPressed(0, 74) then
				ESX.TriggerServerCallback('zentih-vangelico:checkItem', function(data)
					if data then
						...
						exports['np-taskbar']:taskBar(1200,"Kapı Açılıyor",false,true)
						if true then
						...
						exports['mythic_notify']:SendAlert('error', 'Sanırım bunun için kart lazım...')
					end
				end, "secure4")
			end
		end
			...
			if IsControlJustPressed(0, 74) then
				ESX.TriggerServerCallback('zentih-vangelico:checkItem', function(data)
					if data then
						...
						finish = exports['Reload_Skillbar']:taskBar(8000, math.random(10,25))
						exports['np-taskbar']:taskBar(12000,"Kapı Açılıyor",false,true)
						if true then
							...
							ESX.TriggerServerCallback('esx_vangelico_robbery:conteggio', function(CopsConnected)
								if CopsConnected >= Config.RequiredCopsRob then
									...
									if holdingup then
										...
										exports['np-taskbar']:taskBar(3000,"Toplanıyor",false,true)
