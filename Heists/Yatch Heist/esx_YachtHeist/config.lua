...
Config.RequiredPolice = 2			-- required police online for starting heist
Config.EnablePlayerMoneyBag = true			-- enable/disable wearing a bag after cash animation
Config.CooldownTimer = 10					-- in minutes

Config.HackerDevice = "security5"		-- database name for hacking item
...
Config.MinCashTake = 17500				-- this value is multiplied with 100, so 3 means 300. 12 means 1200 and etc.
Config.MaxCashTake = 20000				-- this value is multiplied with 100, so 6 means 600. 16 means 1600 and etc.
Config.SafeMinCash = 50				-- this value is multiplied with 1000, so 10 means 10000. 33 means 33000 and etc.
Config.SafeMaxCash = 50				-- this value is multiplied with 1000, so 25 means 25000. 145 means 145000 and etc.
Config.SafeMinItem = 1				-- this value is multiplied with 10, so 12 means 120. 21 means 210 and etc.
Config.SafeMaxItem = 2				-- this value is multiplied with 10, so 30 means 300. 112 means 1120 and etc.
